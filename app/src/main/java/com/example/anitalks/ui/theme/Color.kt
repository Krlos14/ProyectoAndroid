...
// Colores terciarios (Cian Brillante)
val LightTertiary = Color(0xFF00BCD4)
...
val AnimeTalksFavoriteIconLight = Color(0xFFE91E63) // Rosa Fuerte
val AnimeTalksFavoriteIconDark = Color(0xFFFF4081) // Rosa/Rojo Vibrante para Dark Mode